...
## Project Structure
    ...
    ├── crimson_waterfall_d_60318  # Django project configurations
...
1. Clone this repo and `cd crimson_waterfall_d_60318`
...
2. Clone this repo and `cd crimson_waterfall_d_60318`
